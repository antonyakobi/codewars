...
// Я создал три функции и определил несколько глобальных переменных, пожалуйста, выберите несколько переменных, которые могут составить имя функции, и верните их (пожалуйста, обратите внимание, что заглавные и строчные буквы отличаются).
...
// После завершения задания 1 вы должны нажать кнопку "Попытка", чтобы увидеть три моих вопроса, и написать ответ в функции answer1, answer2, answer3
// 
